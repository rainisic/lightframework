...
public enum HttpStatus {
    ...
    /**
     * Private constructor to construct HTTP status with status code and reason phrase.
     *
     * @param statusCode   status code of HTTP status
     * @param reasonPhrase reason phrase of HTTP status
     */
     ...
     * {@link org.lightframework.http.api.HttpStatus.Series#INFORMATIONAL}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     * @return {@code true} if this status code is in the HTTP series 'informational'
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.lightframework.http.api.HttpStatus.Series#SUCCESSFUL}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     * @return {@code true} if this status code is in the HTTP series 'successful'
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.lightframework.http.api.HttpStatus.Series#REDIRECTION}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     * @return {@code true} if this status code is in the HTTP series 'redirection'
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.lightframework.http.api.HttpStatus.Series#CLIENT_ERROR}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     * @return {@code true} if this status code is in the HTTP series 'client error'
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.lightframework.http.api.HttpStatus.Series#SERVER_ERROR}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     * @return {@code true} if this status code is in the HTTP series 'server error'
     */
    ...
    public static HttpStatus valueOf(int statusCode) {
        ...
        throw new IllegalArgumentException("No matching enum for [" + statusCode + "]");
    }
    ...
    public static enum Series {
        ...
        /** Series numeric value. */
        private final int value;

        /**
         * Private constructor to construct series enumeration.
         *
         * @param value numeric value of enum
         */
        ...
        public static Series valueOf(int status) {
            ...
            throw new IllegalArgumentException("No matching enum for [" + status + "]");
        }

        /**
         * Returns the HTTP status series of this status code.
         *
         * @param status http status to be checked
         *
         * @return HTTP status series
         */
